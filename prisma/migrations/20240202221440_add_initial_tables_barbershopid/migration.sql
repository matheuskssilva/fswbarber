/*
  ...
  - You are about to drop the column `barbeshopId` on the `Booking` table. All the data in the column will be lost.
  - You are about to drop the column `status` on the `Booking` table. All the data in the column will be lost.
  - You are about to drop the column `barbeshopId` on the `Service` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "Booking" DROP CONSTRAINT "Booking_barbeshopId_fkey";

-- DropForeignKey
ALTER TABLE "Service" DROP CONSTRAINT "Service_barbeshopId_fkey";

-- AlterTable
ALTER TABLE "Booking" DROP COLUMN "barbeshopId",
DROP COLUMN "status",
ADD COLUMN     "barbershopId" TEXT NOT NULL;

-- AlterTable
ALTER TABLE "Service" DROP COLUMN "barbeshopId",
ADD COLUMN     "barbershopId" TEXT NOT NULL,
